...
public class FoldersApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<FoldersResponse> callListWithHttpInfo(
      String accountId, FoldersApi.CallListOptions options) throws ApiException {
    ...
    if (options != null) {
      localVarQueryParams.addAll(
          apiClient.parameterToPair("sub_folder_depth", options.subFolderDepth));
    }
    if (options != null) {
    ...
    FoldersResponse localVarResponse =
        apiClient.invokeAPI(
            localVarPath,
            "GET",
            localVarQueryParams,
            ...
            localVarAuthNames,
            localVarReturnType);
    return new ApiResponse<FoldersResponse>(
  ...
  public FolderItemsResponse listItems(
    ...
    ApiResponse<FolderItemsResponse> localVarResponse =
        listItemsWithHttpInfo(accountId, folderId, options);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<FolderItemsResponse> listItemsWithHttpInfo(
      String accountId, String folderId, FoldersApi.ListItemsOptions options) throws ApiException {
    Object localVarPostBody = "{}";
    ...
    FolderItemsResponse localVarResponse =
        apiClient.invokeAPI(
            localVarPath,
            "GET",
            localVarQueryParams,
            ...
            localVarAuthNames,
            localVarReturnType);
    return new ApiResponse<FolderItemsResponse>(
        apiClient.getStatusCode(), apiClient.getResponseHeaders(), localVarResponse);
  }
  ...
  public FoldersResponse moveEnvelopes(
    ...
    ApiResponse<FoldersResponse> localVarResponse =
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<FoldersResponse> moveEnvelopesWithHttpInfo(
      String accountId, String folderId, FoldersRequest foldersRequest) throws ApiException {
  ...
  public FolderItemResponse search(
      ...
      throws ApiException {
    ApiResponse<FolderItemResponse> localVarResponse =
        searchWithHttpInfo(accountId, searchFolderId, options);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<FolderItemResponse> searchWithHttpInfo(
      String accountId, String searchFolderId, FoldersApi.SearchOptions options)
      throws ApiException {
    Object localVarPostBody = "{}";
    ...
    FolderItemResponse localVarResponse =
        apiClient.invokeAPI(
            localVarPath,
            "GET",
            localVarQueryParams,
            ...
            localVarAuthNames,
            localVarReturnType);
    return new ApiResponse<FolderItemResponse>(
        apiClient.getStatusCode(), apiClient.getResponseHeaders(), localVarResponse);
  }
}
