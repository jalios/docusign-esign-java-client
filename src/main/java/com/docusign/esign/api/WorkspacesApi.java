...
public class WorkspacesApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Workspace> createWorkspaceWithHttpInfo(String accountId, Workspace workspace)
      throws ApiException {
  ...
  public WorkspaceItem createWorkspaceFile(String accountId, String workspaceId, String folderId)
      throws ApiException {
    ApiResponse<WorkspaceItem> localVarResponse =
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<WorkspaceItem> createWorkspaceFileWithHttpInfo(
    ...
    WorkspaceItem localVarResponse =
        apiClient.invokeAPI(
            ...
            localVarAuthNames,
            localVarReturnType);
    return new ApiResponse<WorkspaceItem>(
        apiClient.getStatusCode(), apiClient.getResponseHeaders(), localVarResponse);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Object> deleteWorkspaceFolderItemsWithHttpInfo(
      String accountId, String workspaceId, String folderId, WorkspaceItemList workspaceItemList)
      throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Object> getWorkspaceFileWithHttpInfo(
      String accountId,
      String workspaceId,
      String folderId,
      String fileId,
  ...
  public PageImages listWorkspaceFilePages(
    ...
    ApiResponse<PageImages> localVarResponse =
        listWorkspaceFilePagesWithHttpInfo(accountId, workspaceId, folderId, fileId, options);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PageImages> listWorkspaceFilePagesWithHttpInfo(
      String accountId,
      String workspaceId,
      String folderId,
      String fileId,
  ...
  public WorkspaceFolderContents listWorkspaceFolderItems(
      ...
      throws ApiException {
    ApiResponse<WorkspaceFolderContents> localVarResponse =
        listWorkspaceFolderItemsWithHttpInfo(accountId, workspaceId, folderId, options);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<WorkspaceFolderContents> listWorkspaceFolderItemsWithHttpInfo(
      String accountId,
      String workspaceId,
      String folderId,
      WorkspacesApi.ListWorkspaceFolderItemsOptions options)
    ...
    WorkspaceFolderContents localVarResponse =
        apiClient.invokeAPI(
            localVarPath,
            "GET",
            localVarQueryParams,
            ...
            localVarAuthNames,
            localVarReturnType);
    return new ApiResponse<WorkspaceFolderContents>(
        apiClient.getStatusCode(), apiClient.getResponseHeaders(), localVarResponse);
  }
  ...
  public ApiResponse<WorkspaceList> listWorkspacesWithHttpInfo(String accountId)
    ...
    WorkspaceList localVarResponse =
        apiClient.invokeAPI(
            localVarPath,
            "GET",
            localVarQueryParams,
            ...
            localVarAuthNames,
            localVarReturnType);
    return new ApiResponse<WorkspaceList>(
        apiClient.getStatusCode(), apiClient.getResponseHeaders(), localVarResponse);
  }
  ...
  public Workspace updateWorkspace(String accountId, String workspaceId, Workspace workspace)
      throws ApiException {
    ApiResponse<Workspace> localVarResponse =
        updateWorkspaceWithHttpInfo(accountId, workspaceId, workspace);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Workspace> updateWorkspaceWithHttpInfo(
      String accountId, String workspaceId, Workspace workspace) throws ApiException {
    Object localVarPostBody = workspace;
  ...
  public WorkspaceItem updateWorkspaceFile(
      String accountId, String workspaceId, String folderId, String fileId) throws ApiException {
    ApiResponse<WorkspaceItem> localVarResponse =
        updateWorkspaceFileWithHttpInfo(accountId, workspaceId, folderId, fileId);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<WorkspaceItem> updateWorkspaceFileWithHttpInfo(
      String accountId, String workspaceId, String folderId, String fileId) throws ApiException {
    Object localVarPostBody = "{}";
