...
public class CustomTabsApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<TabMetadataList> callListWithHttpInfo(
      String accountId, CustomTabsApi.CallListOptions options) throws ApiException {
    ...
    TabMetadataList localVarResponse =
        apiClient.invokeAPI(
            localVarPath,
            "GET",
            localVarQueryParams,
            ...
            localVarAuthNames,
            localVarReturnType);
    return new ApiResponse<TabMetadataList>(
  ...
  public ApiResponse<TabMetadata> createWithHttpInfo(String accountId, TabMetadata tabMetadata)
    ...
    TabMetadata localVarResponse =
        apiClient.invokeAPI(
            ...
            localVarAuthNames,
            localVarReturnType);
    return new ApiResponse<TabMetadata>(
        apiClient.getStatusCode(), apiClient.getResponseHeaders(), localVarResponse);
  }
  ...
  public TabMetadata update(String accountId, String customTabId, TabMetadata tabMetadata)
      throws ApiException {
    ApiResponse<TabMetadata> localVarResponse =
        updateWithHttpInfo(accountId, customTabId, tabMetadata);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<TabMetadata> updateWithHttpInfo(
      String accountId, String customTabId, TabMetadata tabMetadata) throws ApiException {
    Object localVarPostBody = tabMetadata;
