...
public class EmailArchiveApi {
  ...
  public BccEmailArchive createBCCEmailArchive(String accountId, BccEmailArchive bccEmailArchive)
      throws ApiException {
    ApiResponse<BccEmailArchive> localVarResponse =
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<BccEmailArchive> createBCCEmailArchiveWithHttpInfo(
    ...
    BccEmailArchive localVarResponse =
        apiClient.invokeAPI(
            ...
            localVarAuthNames,
            localVarReturnType);
    return new ApiResponse<BccEmailArchive>(
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Object> deleteBCCEmailArchiveWithHttpInfo(
  ...
  public BccEmailArchiveHistoryList getBCCEmailArchiveHistoryList(
      ...
      throws ApiException {
    ApiResponse<BccEmailArchiveHistoryList> localVarResponse =
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<BccEmailArchiveHistoryList> getBCCEmailArchiveHistoryListWithHttpInfo(
      String accountId,
      String bccEmailArchiveId,
      EmailArchiveApi.GetBCCEmailArchiveHistoryListOptions options)
      throws ApiException {
    ...
    BccEmailArchiveHistoryList localVarResponse =
        apiClient.invokeAPI(
            localVarPath,
            "GET",
            localVarQueryParams,
            ...
            localVarAuthNames,
            localVarReturnType);
    return new ApiResponse<BccEmailArchiveHistoryList>(
        apiClient.getStatusCode(), apiClient.getResponseHeaders(), localVarResponse);
  }
  /// <summary>
  ...
  public BccEmailArchiveList getBCCEmailArchiveList(
    ...
    ApiResponse<BccEmailArchiveList> localVarResponse =
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<BccEmailArchiveList> getBCCEmailArchiveListWithHttpInfo(
      String accountId, EmailArchiveApi.GetBCCEmailArchiveListOptions options) throws ApiException {
    Object localVarPostBody = "{}";
    ...
    BccEmailArchiveList localVarResponse =
        apiClient.invokeAPI(
            ...
            localVarAuthNames,
            localVarReturnType);
    return new ApiResponse<BccEmailArchiveList>(
        apiClient.getStatusCode(), apiClient.getResponseHeaders(), localVarResponse);
  }
}
