...
public class NotaryApi {
  ...
  public NotaryJurisdiction createNotaryJurisdictions(NotaryJurisdiction notaryJurisdiction)
      throws ApiException {
    ApiResponse<NotaryJurisdiction> localVarResponse =
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<NotaryJurisdiction> createNotaryJurisdictionsWithHttpInfo(
    ...
    NotaryJurisdiction localVarResponse =
        apiClient.invokeAPI(
            ...
            localVarAuthNames,
            localVarReturnType);
    return new ApiResponse<NotaryJurisdiction>(
        apiClient.getStatusCode(), apiClient.getResponseHeaders(), localVarResponse);
  }
  ...
  public ApiResponse<NotaryResult> getNotaryWithHttpInfo(NotaryApi.GetNotaryOptions options)
    ...
    NotaryResult localVarResponse =
        apiClient.invokeAPI(
            ...
            localVarAuthNames,
            localVarReturnType);
    return new ApiResponse<NotaryResult>(
        apiClient.getStatusCode(), apiClient.getResponseHeaders(), localVarResponse);
  }
  ...
  public ApiResponse<NotaryJurisdictionList> getNotaryJurisdictionsWithHttpInfo()
    ...
    NotaryJurisdictionList localVarResponse =
        apiClient.invokeAPI(
            ...
            localVarAuthNames,
            localVarReturnType);
    return new ApiResponse<NotaryJurisdictionList>(
        apiClient.getStatusCode(), apiClient.getResponseHeaders(), localVarResponse);
  }
  /// <summary>
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<NotaryJournalList> listNotaryJournalsWithHttpInfo(
    ...
    NotaryJournalList localVarResponse =
        apiClient.invokeAPI(
            ...
            localVarAuthNames,
            localVarReturnType);
    return new ApiResponse<NotaryJournalList>(
        apiClient.getStatusCode(), apiClient.getResponseHeaders(), localVarResponse);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<NotaryJurisdiction> updateNotaryJurisdictionWithHttpInfo(
      String jurisdictionId, NotaryJurisdiction notaryJurisdiction) throws ApiException {
    Object localVarPostBody = notaryJurisdiction;
