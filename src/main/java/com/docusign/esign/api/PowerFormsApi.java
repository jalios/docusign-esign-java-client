...
public class PowerFormsApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PowerForm> createPowerFormWithHttpInfo(String accountId, PowerForm powerForm)
      throws ApiException {
    ...
    PowerForm localVarResponse =
        apiClient.invokeAPI(
            ...
            localVarAuthNames,
            localVarReturnType);
    return new ApiResponse<PowerForm>(
  ...
  /**
   * Deletes one or more PowerForms. This method deletes one or more PowerForms. The request body
   * takes an array of PowerForm objects that are deleted based on the &#x60;powerFormId&#x60;.
   *
   * @param accountId The external account number (int) or account ID Guid. (required)
  ...
  public PowerFormsResponse deletePowerForms(String accountId, PowerFormsRequest powerFormsRequest)
      throws ApiException {
    ApiResponse<PowerFormsResponse> localVarResponse =
        deletePowerFormsWithHttpInfo(accountId, powerFormsRequest);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PowerFormsResponse> deletePowerFormsWithHttpInfo(
      String accountId, PowerFormsRequest powerFormsRequest) throws ApiException {
    ...
    PowerFormsResponse localVarResponse =
        apiClient.invokeAPI(
            ...
            localVarAuthNames,
            localVarReturnType);
    return new ApiResponse<PowerFormsResponse>(
        apiClient.getStatusCode(), apiClient.getResponseHeaders(), localVarResponse);
  }

  /**
   * Returns a single PowerForm.. This method returns detailed information about a specific
   * PowerForm.
   *
   * @param accountId The external account number (int) or account ID Guid. (required)
   * @param powerFormId (required)
  ...
  public PowerFormsFormDataResponse getPowerFormData(
      ...
      throws ApiException {
    ApiResponse<PowerFormsFormDataResponse> localVarResponse =
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PowerFormsFormDataResponse> getPowerFormDataWithHttpInfo(
      String accountId, String powerFormId, PowerFormsApi.GetPowerFormDataOptions options)
      throws ApiException {
    Object localVarPostBody = "{}";
    ...
    PowerFormsFormDataResponse localVarResponse =
        apiClient.invokeAPI(
            ...
            localVarAuthNames,
            localVarReturnType);
    return new ApiResponse<PowerFormsFormDataResponse>(
        apiClient.getStatusCode(), apiClient.getResponseHeaders(), localVarResponse);
  }
  /// <summary>
  ...
  public PowerFormSendersResponse listPowerFormSenders(
    ...
    ApiResponse<PowerFormSendersResponse> localVarResponse =
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PowerFormSendersResponse> listPowerFormSendersWithHttpInfo(
      String accountId, PowerFormsApi.ListPowerFormSendersOptions options) throws ApiException {
    Object localVarPostBody = "{}";
    ...
    PowerFormSendersResponse localVarResponse =
        apiClient.invokeAPI(
            localVarPath,
            "GET",
            localVarQueryParams,
            ...
            localVarAuthNames,
            localVarReturnType);
    return new ApiResponse<PowerFormSendersResponse>(
        apiClient.getStatusCode(), apiClient.getResponseHeaders(), localVarResponse);
  }
  /// <summary>
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PowerFormsResponse> listPowerFormsWithHttpInfo(
      String accountId, PowerFormsApi.ListPowerFormsOptions options) throws ApiException {
    Object localVarPostBody = "{}";
  ...
  public PowerForm updatePowerForm(String accountId, String powerFormId, PowerForm powerForm)
      throws ApiException {
    ApiResponse<PowerForm> localVarResponse =
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<PowerForm> updatePowerFormWithHttpInfo(
