...
/**
 * A Commission State tab displays the state in which a notary&#39;s commission was granted. The tab
 * is populated with the notary&#39;s commission information, but the recipient can also edit the
 * value when notarizing. This tab can only be assigned to a remote notary recipient using [DocuSign
