 ...
 * information to be entered in any format. The tooltip for this tab recommends entering the date as
 * MM/DD/YYYY, but this is not enforced. The format entered by the signer is retained. If you need a
 * particular date format enforced, DocuSign recommends using a Text tab with a validation pattern
 * and a validation message to enforce the format. .
 */
@Schema(
    description =
