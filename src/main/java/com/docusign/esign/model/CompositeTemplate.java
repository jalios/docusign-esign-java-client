...
/**
 * This object contains information about a [composite template][composite], which you can use to to
 * apply multiple templates to a single envelope, combine templates with PDF forms, and combine
 * templates with documents from cloud sources. [composite]:
...
public class CompositeTemplate {
  ...
  /**
   * An optional document object that will act as the primary document in the composite template
   * object. If the document node is present, it will take precedence over any server template or
   * inline template documents. It always comes first. Only use this when you want to supply the
