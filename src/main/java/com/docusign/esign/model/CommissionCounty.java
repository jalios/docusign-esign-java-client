...
/**
 * A Commission County tab displays the county of a notary&#39;s commission. The tab is populated
 * with the notary&#39;s commission information, but the recipient can also edit the value when
 * notarizing. This tab can only be assigned to a remote notary recipient using [DocuSign
