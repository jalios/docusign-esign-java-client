...
/**
 * A Phone Number tab enables a recipient to enter a phone number. **Note:** This tab can only be
 * assigned to a remote notary recipient using [DocuSign Notary][notary]. [notary]:
 * /docs/notary-api/.
 */
@Schema(
    description =
