...
/**
 * A Notary Seal tab enables the recipient to notarize a document. This tab can only be assigned to
 * a remote notary recipient using [DocuSign Notary][notary]. [notary]: /docs/notary-api/.
 */
@Schema(
    description =
