...
public class Document {
  ...
  /**
   * Defines how to generate the responsive-formatted HTML for the document. See [Responsive
   * signing](/docs/esign-rest-api/esign101/concepts/responsive/) in the [eSignature concepts
   * guide](/docs/esign-rest-api/esign101/concepts/)..
   *
