...
/**
 * Contains details about a signing group. Signing groups enable you to send an envelope to a
 * predefined group of recipients and have any one member of the group sign your documents. When you
 * send an envelope to a signing group, anyone in the group can open it and sign it with their own
 * signature..
 */
@Schema(
    description =
