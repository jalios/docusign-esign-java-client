...
/**
 * The value of a formula tab is calculated from the values of other number or date tabs in the
 * document. When the recipient completes the underlying fields, the formula tab calculates and
 * displays the result. The &#x60;formula&#x60; property of the tab contains the references to the
 * underlying tabs. See [Calculated Fields][calculatedfields] in the DocuSign Support Center to
 * learn more about formulas. If a formula tab contains a &#x60;paymentDetails&#x60; property, the
 * tab is considered a payment item. See [Requesting Payments Along with Signatures][paymentguide]
 * in the DocuSign Support Center to learn more about payments. [calculatedfields]:
 * https://support.docusign.com/en/guides/ndse-user-guide-calculated-fields [paymentguide]:
...
public class FormulaTab {
  ...
  /**
   * This property indicates that this formula tab is a payment item. See [Requesting Payments Along
   * with Signatures][paymentguide] in the DocuSign Support Center to learn more about payments.
   * [paymentguide]:
   * https://support.docusign.com/en/guides/requesting-payments-along-with-signatures .
   *
