...
/**
 * A tab that displays the recipient&#39;s first name. This tab takes the recipient&#39;s name as
 * entered in the recipient information, splits it into sections based on spaces and uses the first
