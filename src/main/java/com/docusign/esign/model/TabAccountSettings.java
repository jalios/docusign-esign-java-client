...
public class TabAccountSettings {
  ...
  public String toString() {
    ...
    sb.append("    numericalTabsEnabled: ")
        .append(toIndentedString(numericalTabsEnabled))
        .append("\n");
    sb.append("    numericalTabsMetadata: ")
        .append(toIndentedString(numericalTabsMetadata))
        .append("\n");
