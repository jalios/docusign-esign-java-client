...
/**
 * A complex type containing information about a witness recipient. Witnesses are recipients whose
 * signatures affirm that the identified signers have signed the documents in the envelope..
 */
@Schema(
    description =
