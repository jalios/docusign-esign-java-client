...
/**
 * A complex type containing information about a signer recipient. A signer is a recipient who must
 * take action on a document, such as sign, initial, date, or add data to form fields on a
 * document..
 */
@Schema(
    description =
