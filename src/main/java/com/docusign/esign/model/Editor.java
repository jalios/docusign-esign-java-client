...
/**
 * A complex type defining the management and access rights of a recipient assigned as an editor on
 * the envelope. Editors have the same management and access rights for the envelope as the sender.
 * They can make changes to the envelope as if they were using the Correct feature. This recipient
 * can add name and email information, add or change the routing order and set authentication
 * options for the remaining recipients. Additionally, this recipient can edit signature/initial
...
public class Editor {
  ...
  /**
   * Metadata that indicates whether the `firstName` property is editable. This property is
   * read-only..
   *
  ...
  /**
   * Metadata that indicates whether the `lastName` property is editable. This property is
   * read-only..
   *
  ...
  /**
   * Metadata that indicates whether the `signingGroupId` property is editable. This property is
   * read-only..
   *
