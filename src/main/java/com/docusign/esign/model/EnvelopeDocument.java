...
public class EnvelopeDocument {
  ...
  /**
   * Metadata that indicates if the sender can edit the `authoritativeCopy` property. Not applicable
  ...
  /**
   * Metadata that indicates if the sender can edit the `display` property. Not applicable for
   * template documents..
   *
  ...
  /**
   * Metadata that indicates if the sender can edit the `includeInDownload` property. Not applicable
   * for template documents..
   *
  ...
  /**
   * Metadata that indicates if the sender can edit the `name` property. Not applicable for template
   * documents..
   *
   * @return nameMetadata
   */
  ...
  /**
   * Metadata that indicates if the sender can edit the `signerMustAcknowledge` property. Not
