...
/**
 * Contains information about an intermediary recipient. An intermediary is a recipient who can, but
 * is not required to, add name and email information for recipients at the same or subsequent level
 * in the routing order, unless subsequent agents, editors or intermediaries are added..
 */
@Schema(
    description =
