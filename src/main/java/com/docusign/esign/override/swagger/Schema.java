...
public @interface Schema {
   ...
   *
   * <p>RequiredMode.AUTO: will let the library decide based on its heuristics.
   * RequiredMode.REQUIRED: will force the item to be considered as required regardless of
   * heuristics. RequiredMode.NOT_REQUIRED: will force the item to be considered as not required
   ...
   *
   * <p>AdditionalPropertiesValue.TRUE: set to TRUE AdditionalPropertiesValue.FALSE: set to FALSE
   * AdditionalPropertiesValue.USE_ADDITIONAL_PROPERTIES_ANNOTATION: resolve
   * from @Content.additionalPropertiesSchema
   *
   * @since 2.2.0
   * @return the accessMode for this schema (property)
   */
  AdditionalPropertiesValue additionalProperties() default
