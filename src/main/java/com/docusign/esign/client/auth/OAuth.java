...
public class OAuth implements Authentication {
   ...
   */
  public OAuth(
      HttpClient client, OAuthFlow flow, String authorizationUrl, String tokenUrl, String scopes) {
    this(
        client,
  ...
  public OAuth(OAuthFlow flow, String authorizationUrl, String tokenUrl, String scopes) {
    this(HttpClients.createDefault(), flow, authorizationUrl, tokenUrl, scopes);
  }
  ...
  public synchronized void updateAccessToken() throws ApiException {
    ...
    if (accessTokenResponse != null) {
      ...
      // HTTP resonse
      if (accessTokenResponse.getResponseCode() != HttpStatus.SC_OK) {
  ...
  public void setOauthClient(HttpClient client) {
    this.oauthClient = new OAuthClient(new URLConnectionClient());
  }
